...
htmlhelp_basename = 'sphinx-tutorial-doc'
...
latex_documents = [
  ('index', 'sphinx-tutorial.tex', u"Brandon's Sphinx Tutorial",
...
man_pages = [
    ('index', 'sphinx-tutorial', u"Brandon's Sphinx Tutorial",
     [u'Brandon Rhodes'], 1)
]
...
texinfo_documents = [
  ('index', 'sphinx-tutorial', u'Sphinx Tutorial',
   u'Brandon Rhodes', 'sphinx-tutorial', 'One line description of project.',
   'Miscellaneous'),
]
